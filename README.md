...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gapxsumpw/actions/workflows/test.yml/badge.svg?branch=v0.0.8
[test-url]: https://github.com/stdlib-js/blas-ext-base-gapxsumpw/actions/workflows/test.yml?query=branch:v0.0.8
